...
function publicUser(u) {
  return {
    ...
    email: u.email,
    role: u.role || "user",
    emailNotifications: u.emailNotifications === undefined ? true : !!u.emailNotifications,
...
/* PATCH /api/auth/me — update profile fields (name, notification pref) - */
router.patch("/me", requireAuth, (req, res) => {
  ...
  if (req.body.emailNotifications !== undefined) {
    patch.emailNotifications = req.body.emailNotifications ? 1 : 0;
  }
